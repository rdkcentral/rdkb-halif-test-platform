...
4.  For Supported_CPUS :
        ...
        b.If only HOST_PEER is supported, fill this param as below:
        Supported_CPUS:
            - 1

        c. Both HOST_CPU and PEER_CPU are supported, fill this param as below:
        Supported_CPUS:
            - 0
            - 1
...
5.  For Supported_PSM_STATE :
        ...
        a. If only PSM_AC is supported , fill this param as below:
        Supported_PSM_STATE:
            - 1

        b. If only PSM_BATT is supported , fill this param as below:
        Supported_PSM_STATE:
            - 2

        c. If only PSM_HOT is supported , fill this param as below:
        Supported_PSM_STATE:
            - 3

        d. If only PSM_COOLED is supported , fill this param as below:
        Supported_PSM_STATE:
            - 4
...
6.  For FanIndex:
        ...
        b. If platform supports 2 fans , fill this param as below:
        FanIndex:
            - 0
            - 1
